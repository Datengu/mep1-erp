...
namespace Mep1.Erp.Infrastructure.Migrations
{
    ...
    [Migration("20260202165143_AddApplications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mep1.Erp.Core.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<decimal?>("AgreedNetAmount")
                    ...
                    b.Property<decimal>("SubmittedNetAmount")
                        .HasColumnType("numeric");
                    ...
                    b.HasIndex("ProjectCode", "ApplicationNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("Mep1.Erp.Core.Invoice", b =>
                {
                    b.HasOne("Mep1.Erp.Core.Application", "Application")
                        .WithOne("Invoice")
                        .HasForeignKey("Mep1.Erp.Core.Invoice", "ApplicationId")
